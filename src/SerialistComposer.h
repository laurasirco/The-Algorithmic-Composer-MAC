...
public:
	...
	void setMelodicClasses(vector<int> mC){ if(mC.size() == 12) melodicClasses = mC; }
	void setRhythmicClasses(vector<Type> rC){ if(rC.size() == 12) rhythmicClasses = rC; }
	
	void setOriginalSeries(vector<int> o){ if(o.size() == 12) original = o; }
